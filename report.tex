...
Not everything has a strict surface. Sphere tracing expects the world to be made of solid objects.  But if you try to render smoke, hair, or fire, there's no real 'surface' to hit. Moreover, volume rendering just uses a density field, so it naturally handles all the fluffy and transparent stuff that SDFs struggle with.
...
\subsection{Effect of number and type of sampling}
